...
def test_openapi_contains_auth_user_and_health_operations() -> None:
    ...
    assert set(openapi["paths"]["/api/v1/tasks/{task_id}"]) == {
        "patch",
        "delete",
    }
    assert set(openapi["paths"]["/api/v1/projects/{project_id}/labels"]) == {
        "get",
        "post",
    }
    assert set(openapi["paths"]["/api/v1/labels/{label_id}"]) == {
        "get",
        "patch",
        "delete",
    }
    assert set(openapi["paths"]["/api/v1/tasks/{task_id}/labels/{label_id}"]) == {
        "put",
        "delete",
    }
    assert set(openapi["paths"]["/api/v1/tasks/{task_id}/comments"]) == {
        "post",
    }
    assert set(openapi["paths"]["/api/v1/comments/{comment_id}"]) == {
        "delete",
    }
    assert (
